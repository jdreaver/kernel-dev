...
kernel_config_fragment="board/reaver/stm32mp157d/kernel.fragment"
...
BR2_LINUX_KERNEL_CONFIG_FRAGMENT_FILES="\$(BR2_EXTERNAL_REAVER_STM32MP157D_PATH)/$kernel_config_fragment"
